...
public class CommHelper {
	...
	/**
	 * http://stackoverflow.com/questions/10382578/flow-controll-settings-for-serial-communication-between-java-rxtx-and-arduino
	 * 
	 */
	...
	public void listPorts() {
		...
		java.util.Enumeration<CommPortIdentifier> ports =
	...
	public void initSerialPort(SerialPort port) throws UnsupportedCommOperationException, IOException, TooManyListenersException {
	...
	public void connect(CommPortIdentifier port) {
		...
		try {
			...
			Gdx.app.error(
				"CommHelper", port + " is in use. (" + e.toString() + ")");
		} catch (Exception e) {
			Gdx.app.error(
				"CommHelper",
	...
	public void connectToFirstPort() {
		Gdx.app.log("CommPort", "list port");
